...
def before_uninstall():
	try:
		print("Removing customizations created by Kaya EHR for LTC...")
		remove_customizations()

	except Exception as e:
		BUG_REPORT_URL = "https://github.com/frappe/health/issues/new"
		click.secho(
			"Removing Customizations for Kaya EHR for LTC failed due to an error."
			" Please try again or"
	...
	click.secho("Kaya EHR for LTC app customizations have been removed successfully...", fg="green")
